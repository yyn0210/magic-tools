package com.magictools.crypto.asymmetric;

import com.magictools.core.lang.Assert;
import com.magictools.core.util.HexUtil;
import com.magictools.crypto.BCUtil;
import com.magictools.crypto.CryptoException;
import com.magictools.crypto.ECKeyUtil;
...
public class SM2 extends AbstractAsymmetricCrypto<SM2> {
	 ...
	 * * 在硬件签名中，返回结果为R+S，可以通过调用{@link com.magictools.crypto.SmUtil#rsAsn1ToPlain(byte[])}方法转换之。
	 *
	 * @param data 加密数据
	 * @return 签名
	 */
