...
public class GlobalLogFactory {
	 ...
	 * 自定义日志实现
	 *
	 * @see com.magictools.log.dialect.slf4j.Slf4jLogFactory
	 * @see com.magictools.log.dialect.log4j.Log4jLogFactory
	 * @see com.magictools.log.dialect.log4j2.Log4j2LogFactory
	 * @see com.magictools.log.dialect.commons.ApacheCommonsLogFactory
	 * @see com.magictools.log.dialect.jdk.JdkLogFactory
	 * @see com.magictools.log.dialect.console.ConsoleLogFactory
	 *
