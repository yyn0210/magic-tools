package com.magictools.core.io;

import com.magictools.core.collection.CollUtil;
import com.magictools.core.io.file.FileReader;
import com.magictools.core.io.file.*;
import com.magictools.core.io.file.FileReader.ReaderHandler;
import com.magictools.core.io.file.FileWriter;
import com.magictools.core.io.resource.ResourceUtil;
import com.magictools.core.io.unit.DataSizeUtil;
import com.magictools.core.lang.Assert;
import com.magictools.core.thread.ThreadUtil;
import com.magictools.core.util.*;
...
public class FileUtil extends PathUtil {
	...
	public static BufferedWriter getWriter(File file, Charset charset, boolean isAppend) throws IORuntimeException {
		return com.magictools.core.io.file.FileWriter.create(file, charset).getWriter(isAppend);
	}
	...
	public static File writeString(String content, File file, String charset) throws IORuntimeException {
		return com.magictools.core.io.file.FileWriter.create(file, CharsetUtil.charset(charset)).write(content);
	}
	...
	public static File writeString(String content, File file, Charset charset) throws IORuntimeException {
		return com.magictools.core.io.file.FileWriter.create(file, charset).write(content);
	}
	...
	public static File appendString(String content, File file, String charset) throws IORuntimeException {
		return com.magictools.core.io.file.FileWriter.create(file, CharsetUtil.charset(charset)).append(content);
	}
	...
	public static File appendString(String content, File file, Charset charset) throws IORuntimeException {
		return com.magictools.core.io.file.FileWriter.create(file, charset).append(content);
	}
	...
	public static <T> File writeLines(Collection<T> list, File file, String charset, boolean isAppend) throws IORuntimeException {
		return com.magictools.core.io.file.FileWriter.create(file, CharsetUtil.charset(charset)).writeLines(list, isAppend);
	}
	...
	public static <T> File writeLines(Collection<T> list, File file, Charset charset, boolean isAppend) throws IORuntimeException {
		return com.magictools.core.io.file.FileWriter.create(file, charset).writeLines(list, isAppend);
	}
	...
	public static File writeUtf8Map(Map<?, ?> map, File file, String kvSeparator, boolean isAppend) throws IORuntimeException {
		return com.magictools.core.io.file.FileWriter.create(file, CharsetUtil.CHARSET_UTF_8).writeMap(map, kvSeparator, isAppend);
	}
	...
	public static File writeMap(Map<?, ?> map, File file, Charset charset, String kvSeparator, boolean isAppend) throws IORuntimeException {
		return com.magictools.core.io.file.FileWriter.create(file, charset).writeMap(map, kvSeparator, isAppend);
	}
	...
	public static File writeBytes(byte[] data, File dest, int off, int len, boolean isAppend) throws IORuntimeException {
		return com.magictools.core.io.file.FileWriter.create(dest).write(data, off, len, isAppend);
	}
	...
	public static File writeFromStream(InputStream in, File dest, boolean isCloseIn) throws IORuntimeException {
		return com.magictools.core.io.file.FileWriter.create(dest).writeFromStream(in, isCloseIn);
	}
