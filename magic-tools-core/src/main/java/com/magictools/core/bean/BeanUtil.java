package com.magictools.core.bean;

import com.magictools.core.bean.copier.BeanCopier;
import com.magictools.core.bean.copier.CopyOptions;
import com.magictools.core.bean.copier.ValueProvider;
...
public class BeanUtil {
	 ...
	 * 如果isSimple为{@code false}，则只匹配类名而忽略包名，例如：com.magictools.TestEntity只匹配TestEntity<br>
	 * 如果isSimple为{@code true}，则匹配包括包名的全类名，例如：com.magictools.TestEntity匹配com.magictools.TestEntity
	 *
	 * @param bean          Bean
