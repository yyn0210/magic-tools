...
public class ComputerUniqueIdentificationUtil {
	private final static Log log = LogFactory.getLog(ComputerUniqueIdentificationUtil.class);
	...
	public static String getMACAddress() {
		switch (getOSNamePrefix()) {
			...
			case LINUX:
				...
				if (StrUtil.isEmpty(macAddressForEth0)) {
	...
	private static class ComputerUniqueIdentification {
		...
		public String getCPUIdentification() {
			return CPUIdentification;
		}

		public void setCPUIdentification(String CPUIdentification) {
			this.CPUIdentification = CPUIdentification;
		}
