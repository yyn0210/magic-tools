...
import com.magictools.core.lang.func.*;
 ...
 * <p>
 * 该工具通过函数式的方式将那些需要抛出受检查异常的表达式或者代码段转化成一个 com.magictools.core.lang.func.Func* 对象
 * </p>
 * <p>
 * {@code
 * <pre>
 ...
 *       // use describedObject ...
 *
 *       CheckedUtil.uncheck 方法接受任意可以转化成 com.magictools.core.lang.func.Func* 函数式接口的 Lambda 表达式。返回对应的函数式对象。
 *       上述代码可以理解为：
...
public class CheckedUtil {
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.Func 的Lambda表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.Func0 的Lambda表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	 * 如此一来，代码中就不用显示的try-catch转化成运行时异常
	 *
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.Func1 的Lambda表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	 * 如此一来，代码中就不用显示的try-catch转化成运行时异常
	 *
	 * @param expression 运行时传入的参数类型
	 * @param <P>        运行时传入的参数类型
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.VoidFunc 的Lambda表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	 * 如此一来，代码中就不用显示的try-catch转化成运行时异常
	 *
	 * @param expression 运行时传入的参数类型
	 * @param <P>        运行时传入的参数类型
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.VoidFunc0 的Lambda表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	 * 如此一来，代码中就不用显示的try-catch转化成运行时异常
	 *
	 * @param expression 运行时传入的参数类型
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.VoidFunc1 的Lambda表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	 * 如此一来，代码中就不用显示的try-catch转化成运行时异常
	 *
	 * @param expression 运行时传入的参数类型
	 * @param <P>        运行时传入的参数类型
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.Func的Lambda表达式，和一个可以把Exception转化成RuntimeExceptionde的表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	 * 如此一来，代码中就不用显示的try-catch转化成运行时异常
	 *
	 * @param expression  Lambda表达式
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.Func0的Lambda表达式，和一个可以把Exception转化成RuntimeExceptionde的表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	 * 如此一来，代码中就不用显示的try-catch转化成运行时异常
	 *
	 * @param expression  Lambda表达式
	 * @param rteSupplier 转化运行时异常的表达式
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.Func1的Lambda表达式，和一个可以把Exception转化成RuntimeExceptionde的表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	 * 如此一来，代码中就不用显示的try-catch转化成运行时异常
	 *
	 * @param expression  Lambda表达式
	 * @param rteSupplier 转化运行时异常的表达式
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.VoidFunc的Lambda表达式，和一个可以把Exception转化成RuntimeExceptionde的表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	 * 如此一来，代码中就不用显示的try-catch转化成运行时异常
	 *
	 * @param expression  Lambda表达式
	 * @param rteSupplier 转化运行时异常的表达式
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.VoidFunc0的Lambda表达式，和一个RuntimeException，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	 * 如此一来，代码中就不用显示的try-catch转化成运行时异常
	 *
	 * @param expression Lambda表达式
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.VoidFunc0的Lambda表达式，和一个可以把Exception转化成RuntimeExceptionde的表达式，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	 * 如此一来，代码中就不用显示的try-catch转化成运行时异常
	 *
	 * @param expression  Lambda表达式
	 * @param rteSupplier 转化运行时异常的表达式
	...
	/**
	 * 接收一个可以转化成 com.magictools.core.lang.func.VoidFunc1的Lambda表达式，和一个RuntimeException，当执行表达式抛出任何异常的时候，都会转化成运行时异常
	 * 如此一来，代码中就不用显示的try-catch转化成运行时异常
	 *
	 * @param expression  Lambda表达式
	 * @param rteSupplier 转化运行时异常的表达式
